  ...
  return (
    <section id="about" className="min-h-screen flex items-center justify-center py-20">
      <div className="max-w-3xl mx-auto px-4 ">
        <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-emerald-500 to-sky-400 bg-clip-text text-transparent text-center">About Me</h2>
            ...
            <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
              ...
              <div className="flex flex-wrap gap-2">
                {frontendSkills.map((tech) => (
                  <span className="bg-emerald-500/10 px-3 py-1 rounded-full text-sm font-semibold hover:text-emerald-400 hover:bg-emerald-500/20  hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] transition" key={tech}>
                    {tech}
                  </span>
                ))}
              </div>
          ...
          <div className="rounded-xl p-6 border-white/10 border  hover:-translate-y-1 transition-all">
            ...
            <div className="space-y-4 text-gray-300">
                <div>
                  ...
                  <p> Developed ReactJS frontend for a seamless user experience while leading a team and managing project progress.</p> 
                </div>
                <div>
                  <h4  className="font-semibold">Frontend Developer Intern at MakkPress Technologies (2021-2022) </h4> 
                  <p>  Assisted in translating client designs into responsive,  interactive web pages.
                 </p>
                </div>
            </div>
          </div>
